...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (isset($_POST['nisn']) && isset($_POST['status_kehadiran']) && isset($_POST['waktu']) && isset($_POST['tanggal'])) {
        ...
        if (mysqli_query($koneksi, $query)) {
            echo "<script>alert('Presensi berhasil ditambahkan!'); window.location.href = 'presensi2.php';</script>";
        } else {
...
<body>
<div class="content">
    <a href="presensi2.php" style="display: inline-block; margin-bottom: 20px; padding: 10px 20px; background-color: #A7C7E7; color: white; text-decoration: none; border-radius: 8px; font-size: 16px;">
    ⬅ Kembali
</a>
    <div class="content">
