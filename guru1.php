...
<body>
    ...
    <div class="sidebar">
        ...
        <nav>
            ...
            <a href="guru1.php" class="active">Data Guru</a>
            <a href="presensi1.php">Data Presensi</a>
            <a href="siswa1.php">Data Siswa</a>
            <a href="cetak1guru.php">Cetak</a>
        </nav>
    </div>
                ...
                <?php while ($row = $result->fetch_assoc()): ?>
                    <div class="card">
                        ...
                        <div class="card-actions">
                            <a href="edit1guru.php?id=<?= $row['nip'] ?>" class="btn-edit">Edit</a>
                            <a href="hapus1guru.php?id=<?= $row['nip'] ?>" class="btn-delete">Hapus</a>
                            <a href="view1guru.php?id=<?= $row['nip'] ?>" class="btn-view">View</a>
                        </div>
                    </div>
                <?php endwhile; ?>
            <?php else: ?>
